 ...
 * News Section
 * 
 * slug: packers-logistic/news-section
 * title: News Section
 * categories: packers-logistic
 */

    return array(
        'title'      =>__( 'News Section', 'packers-logistic' ),
        ...
        <p class="has-text-align-center testimonial-heading has-secaccent-color has-text-color has-link-color has-fira-sans-font-family has-medium-font-size" style="border-radius:5px;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--50);font-style:normal;font-weight:600">'. esc_html__('News & Blogs','packers-logistic').'</p>
        <!-- /wp:paragraph -->

        <!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"600","fontSize":"27px"},"elements":{"link":{"color":{"text":"var:preset|color|accent"}}}},"textColor":"accent","fontFamily":"fira-sans"} -->
        <h2 class="wp-block-heading has-text-align-center has-accent-color has-text-color has-link-color has-fira-sans-font-family" style="font-size:27px;font-style:normal;font-weight:600">'. esc_html__('Our Latest News & blogs','packers-logistic').'</h2>
        <!-- /wp:heading -->
        ...
        <!-- wp:post-title {"isLink":true,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"primary","fontFamily":"fira-sans"} /--></div>
        <!-- /wp:group -->
