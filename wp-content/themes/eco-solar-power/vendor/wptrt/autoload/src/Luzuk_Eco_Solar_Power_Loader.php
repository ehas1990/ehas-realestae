...
class Luzuk_Eco_Solar_Power_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function luzuk_eco_solar_power_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function luzuk_eco_solar_power_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function luzuk_eco_solar_power_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function luzuk_eco_solar_power_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->luzuk_eco_solar_power_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function luzuk_eco_solar_power_load( $class ) {
