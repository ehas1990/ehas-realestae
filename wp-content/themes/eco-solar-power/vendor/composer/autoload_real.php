...
class Luzuk_Eco_Solar_Power_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function luzuk_eco_solar_power_loadClassLoader($class)
    {
    ...
    public static function luzuk_eco_solar_power_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
